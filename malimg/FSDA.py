...
feature_mean = torch.zeros(25,64) #64
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch < 80:
            ...
            train_FSDA(imbalanced_train_loader, model, optimizer_a, epoch, criterion, alpha,kg,beta,out_new,feature_mean,args)
