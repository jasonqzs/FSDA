...
from loss_std import *
from resnet_std import *
...
root_1 = current_directory + "/log/res50_mli_bal.log"
root_2 = current_directory + "/log/res50_mli_bal.log_file"
...
feature_mean = torch.zeros(25, 2048)  # 64
...
# 数据集根目录
current_directory = os.path.dirname(__file__)
dataset_root = current_directory + "/malimg_dataset/bal_dataset"
...
def get_feature_mean(imbalanced_train_loader, model, class_num):
    model.eval()
    feature_mean_end = torch.zeros(class_num, 2048)
    with torch.no_grad():
