...
root_1 = current_directory + "/log/res50_mle_50_n.log"
root_2 = current_directory + "/log/res50_mle_50_n.log_file"
...
parser.add_argument('--beta', default=1, type=float, help='[0.25, 0.5, 0.75, 1.0,1.5]')
...
feature_mean = torch.zeros(26, 2048)  # 64
...
def validate(val_loader, model, criterion, epoch):
    ...
    for i, (input, target) in enumerate(val_loader):
        ...
        # prec1 = accuracy_score(target, output_numpy)
