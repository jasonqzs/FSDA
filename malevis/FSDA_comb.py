...
root_1 = current_directory + "/log/res_comb_mle_50_n.log"
root_2 = current_directory + "/log/res_comb_mle_50_n.log_file"
...
feature_mean = torch.zeros(26, 4096)  # 64
...
def main():
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        if epoch < 100:
            ...
            if True:
                # print('Do not freeze feature weights except for self attention weights (if exist).')
...
def train(train_loader, model, optimizer_a, epoch):
    ...
    for i, (input, target) in enumerate(train_loader):
        ...
        # output_numpy = y_f.data.cpu().numpy()
        # prec_train = accuracy_score(target, output_numpy)
